    ...
    <div className="container mx-auto p-4 relative">
        ...
        {movies.map((movie) => (
          <div key={movie.id} className="w-60 h-auto mx-2 flex-none">
              <img
                ...
                alt={movie.title}
                className="w-full h-auto rounded shadow-lg transition-transform duration-300 transform hover:scale-105"
                style={{ maxWidth: '100%' }}
              />
          </div>
        ))}
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-4 rounded-lg shadow-md">
          ...
          <img src="../../public/imagenes/estreno.png" alt="" className=" h-auto ml-8" />
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-md">
          ...
          <img src="../../public/imagenes/oferta.png" alt="" className=" h-auto ml-8" />
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-md">
          ...
          <img src="../../public/imagenes/combo.png" alt="" className="w-40 h-auto ml-20" />
        </div>
      ...
      <div class="flex">
        <img src="../../public/imagenes/teatro.jpg" alt="" className="w-80 h-auto ml-5" />
